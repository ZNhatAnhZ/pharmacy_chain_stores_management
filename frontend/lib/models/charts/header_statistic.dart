class HeaderStatistic {
  ...
  double? order_percent_from_last_month;
  int? import_inventories_month_count;
  int? import_inventories_month_price;
  double? im_percent_from_last_month;
  HeaderStatistic({
  ...
  factory HeaderStatistic.fromJson(Map<String, dynamic> json) {
    return HeaderStatistic(
      ...
      order_percent_from_last_month:
          json['order_percent_from_last_month'] ?? -1,
      import_inventories_month_count:
          json['import_inventories_month_count'] ?? -1,
      import_inventories_month_price:
          json['import_inventories_month_price'] ?? -1,
