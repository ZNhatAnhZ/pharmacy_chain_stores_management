      ...
      class CustomerAuthController < Base
        def create
          ...
          if customer&.authenticate params[:password]
            ...
            render json: {access_token: @data[:access_token], customer: customer&.id,
              customer: customer&.name, customer_email: customer&.email, customer_address: customer&.address, customer_contact: customer&.contact, customer_gender: customer&.gender}, status: :ok
          else
